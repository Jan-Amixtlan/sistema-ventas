...
const SalesBenefitsTimeline = () => {
    ...
    // Función para redirigir a la página web de OSDEMS
    const handleMasInformacion = () => {
        console.log('Botón Más Información clickeado - redirigiendo a OSDEMS'); // Debug
        const websiteUrl = 'https://osdemsdigital.com';
            ...
            <section className="cta-section">
                <div className="cta-container">
                    ...
                    <div className="cta-actions">
                        ...
                        <button className="cta-btn secondary" onClick={handleMasInformacion}>
                            <svg fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2}
